...
<head>
  ...
  <link rel="stylesheet" href="{{asset("public/adminassets/dist/css/skins/skin-blue.min.css")}}">

  <link rel="stylesheet" href="{{asset("public/adminassets/plugins/datepicker/datepicker3.css") }}">
...
<script src="{{ asset("public/adminassets/plugins/datepicker/bootstrap-datepicker.js") }}"></script>
...
<!-- AdminLTE App -->
<script src="{{asset("public/adminassets/dist/js/app.min.js")}}"></script>

<script src="{{ asset("public/adminassets/plugins/datatables/jquery.dataTables.min.js") }}"></script>

<script src="{{ asset("public/adminassets/plugins/datatables/dataTables.bootstrap.min.js") }}"></script>
<!-- SlimScroll -->
<script src="{{ asset("public/adminassets/plugins/slimScroll/jquery.slimscroll.min.js") }}"></script>
<!-- FastClick -->
<script src="{{ asset("public/adminassets/plugins/fastclick/fastclick.js") }}"></script>
