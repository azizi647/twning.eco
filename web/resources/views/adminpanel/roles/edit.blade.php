          ...
          <form class="form-horizontal" method="Post" action="{{ url(LaravelLocalization::setLocale().'/twadm/roles/').'/'.$role->id }}">
            ...
            <div class="flash-message">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputTitle" placeholder="name" name="title" value="{{ $role->title }}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputSlug" placeholder="slug" name="slug" value="{{ $role->slug }}">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  @foreach($permissions as $permission)
                    <option  @if( $role->permissions->contains($permission->id) ) selected @endif value="{{ $permission->id }}">{{$permission->title}}</option>
                  @endforeach
                  </select>
                </div>
              </div>
