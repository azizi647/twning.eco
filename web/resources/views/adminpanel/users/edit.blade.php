  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/{{ LaravelLocalization::setLocale() }}/twadm/users"></i> Users </a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" method="Post" action="{{ url(LaravelLocalization::setLocale().'/twadm/users/'.$user->id)}}">
            <div class="box-body">
            ...
            <div class="box-footer">
              ...
              <a href="/twadm/users" class="btn btn-default">Cancel</a>
